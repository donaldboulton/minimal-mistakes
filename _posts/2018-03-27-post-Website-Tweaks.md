...
image:
  cover: true
  path: &image /dest/assets/images/pages/performance/speedtest_donboulton.jpg
  feature: *image
  thumbnail: /dest/assets/images/pages/performance/speedtest_donboulton-320.jpg
header:
  image: /dest/assets/images/pages/performance/speedtest_donboulton.jpg
  teaser: /dest/assets/images/pages/performance/speedtest_donboulton-320.jpg
...
{% include figure image_path="/dest/assets/images/pages/performance/orchard-performance.jpg" alt="Performance" caption="Performance" class="align-center" %}
...
{% include figure image_path="/dest/assets/images/pages/performance/cache-settings.jpg" alt="Cache Settings" caption="Cache Settings" class="align-center" %}
...
{% include figure image_path="/dest/assets/images/pages/performance/cache-duration-min.jpg" alt="Cache Duration" caption="Cache Duration" class="align-center" %}
...
{% include figure image_path="/dest/assets/images/pages/performance/http-request.png" alt="Http-Request" caption="Http-Request" class="align-left" %}
...
{% include figure image_path="/dest/assets/images/pages/performance/http-cache-control.png" alt="Cache Control" caption="Cache Control" class="align-left" %}
...
{% include figure image_path="/dest/assets/images/pages/performance/http-cache-control-highlight.png" alt="Cache Control" caption="Cache Control" class="align-left" %}
...
{% include figure image_path="/dest/assets/images/pages/performance/http-cache-decision-tree.png" alt="Http Cache" caption="Cache Http Cache" class="align-center" %}
...
{% include figure image_path="/dest/assets/images/pages/performance/http-cache-hierarchy.png" alt="Cache Hierarchy" caption="Cache Hierarchy" class="align-left" %}
...
{% include figure image_path="/dest/assets/images/pages/performance/ilyagrigorik.jpg" alt="Profile photo of Ilya Grigorik" caption="Profile photo of Ilya Grigorik" class="align-left" %}
