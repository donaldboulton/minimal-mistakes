...
$(window).scroll(function(){if($(this).scrollTop()>50){$('.scrolltop:hidden').stop(!0,!0).fadeIn()}else{$('.scrolltop').stop(!0,!0).fadeOut()}});$(function(){$(".scroll").click(function(){$("html,body").animate({scrollTop:$(".thetop").offset().top},"2500");return!1})})