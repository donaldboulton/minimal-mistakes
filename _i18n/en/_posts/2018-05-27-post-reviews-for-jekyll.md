...
My [icons.svg](https://raw.githubusercontent.com/donaldboulton/DWB/gh-pages/dest//assets/images/icons.svg) file requires [svg4everybody.js](https://github.com/jonathantneal/svg4everybody) to work correctly, unless your using fontawesome 5.0+, it's javascript will allow browsers to view svg icon files.
...
(function ($) {
    ...
    $('#review-form').submit(function () {
      ...
      $("#review-form-submit").html(
        '<svg class="icon spin"><use xlink:href="/dest//assets/images/icons.svg#icon-loading"></use></svg> Loading...'
      );
